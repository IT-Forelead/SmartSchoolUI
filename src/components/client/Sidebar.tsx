    ...
    <div className='flex items-center'>
      <div className='relative w-64 h-screen py-2.5 bg-white border-r border-gray-200 px-7'>
        ...
        <ul className='mt-20 font-medium space-y-7'>
          <li className={`flex items-center text-gray-500 transition-all duration-300 cursor-pointer hover:text-gray-900 hover:font-semibold ${router.pathname === "/" ? "text-gray-900" : ''}`}>
